...
export default defineConfig({
  // GitHub Pages serves this repository under /minimax-of-duty/.
  // Vercel migration was completed previously; keep the deployed target explicit.
  base: '/minimax-of-duty/',
